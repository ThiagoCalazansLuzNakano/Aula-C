...
int main(){
    ...
    float notas[quantidade_notas];// "float notas[3];" nota 1, nota 2, nota 3, ..., nota n -->definido pelo usuário
    //notas[0] = 10;
    //notas[1] = 8;
    //notas[2] = 6;
    float soma = 0;
    ...
    float media = soma/ quantidade_notas; //float media = (notas[0] + notas[1] + notas[2])/ 3;
